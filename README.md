...
Estruturas de Controle: Domínio de condicionais (if/else, switch) e laços de repetição (for, while, do-while).
Estruturas de Dados: Uso de Arrays e coleções dinâmicas (ArrayList, List).
Lógica Matemática: Resolução de problemas de cálculo, conversão de unidades e estatística básica.
Entrada e Saída de Dados: Manipulação de dados com as classes Scanner e System.out.
